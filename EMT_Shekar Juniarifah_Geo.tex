...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-001.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-004.png}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT_Shekar Juniarifah_Geo-006-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT_Shekar Juniarifah_Geo-008-large.png}
\begin{eulerprompt}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT_Shekar Juniarifah_Geo-014-large.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-018.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-020.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-021.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT_Shekar Juniarifah_Geo-033.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/EMT_Shekar Juniarifah_Geo-037-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-038.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT_Shekar Juniarifah_Geo-045-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-049.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT_Shekar Juniarifah_Geo-053-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-056.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-059.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-061.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-066.png}
...
\begin{eulerformula}
\[
{\it getHesseForm}\left({\it lineThrough}\left(\left[ \frac{-c^2+b^  2+a^2}{2\,a} , \frac{\sqrt{-c^4+2\,b^2\,c^2+2\,a^2\,c^2-b^4+2\,a^2\,  b^2-a^4}}{2\,a} \right]  , \left[ 0 , 0 \right] \right) , x , y ,   \left[ a , 0 \right] \right)-{\it distance}\left(\left[ x , y   \right]  , \left[ a , 0 \right] \right)=0
\]
\end{eulerformula}
\begin{eulercomment}
...
\begin{eulerformula}
\[
{\it getHesseForm}\left({\it lineThrough}\left(A , B\right) , x , y   , C\right)=-{\it distance}\left(\left[ x , y \right]  , C\right)
\]
\end{eulerformula}
\begin{eulercomment}
...
\begin{eulerformula}
\[
g\left(x\right)=-{\it getHesseForm}\left({\it lineThrough}\left(  \left[ \frac{-c^2+b^2+a^2}{2\,a} , \frac{\sqrt{-c^4+\left(2\,b^2+2\,  a^2\right)\,c^2-b^4+2\,a^2\,b^2-a^4}}{2\,a} \right]  , \left[ 0 , 0   \right] \right) , x , y , \left[ a , 0 \right] \right)
\]
\end{eulerformula}
\begin{eulerprompt}
...
\begin{eulerformula}
\[
{\it distance}\left(\left[ -1.0 , -1.0\,{\it getHesseForm}\left(  {\it lineThrough}\left(\left[ \frac{0.5\,\left(-1.0\,c^2+b^2+a^2  \right)}{a} , \frac{0.5\,\sqrt{-1.0\,c^4+\left(2.0\,b^2+2.0\,a^2  \right)\,c^2-1.0\,b^4+2.0\,a^2\,b^2-1.0\,a^4}}{a} \right]  , \left[   0.0 , 0.0 \right] \right) , -1.0 , y , \left[ a , 0.0 \right]   \right) \right]  , \left[ a , 0.0 \right] \right)
\]
\end{eulerformula}
\eulerimg{0}{images/EMT_Shekar Juniarifah_Geo-071-large.png}
\begin{eulerprompt}
>U &= projectToLine(T,lineThrough(A,B)); $U // proyeksi T pada garis AB 
\end{eulerprompt}
\begin{eulerformula}
\[
{\it projectToLine}\left(\left[ -1 , -{\it getHesseForm}\left(  {\it lineThrough}\left(\left[ \frac{-c^2+b^2+a^2}{2\,a} , \frac{  \sqrt{-c^4+\left(2\,b^2+2\,a^2\right)\,c^2-b^4+2\,a^2\,b^2-a^4}}{2\,  a} \right]  , \left[ 0 , 0 \right] \right) , -1 , y , \left[ a , 0   \right] \right) \right]  , {\it lineThrough}\left(\left[ \frac{-c^2  +b^2+a^2}{2\,a} , \frac{\sqrt{-c^4+2\,b^2\,c^2+2\,a^2\,c^2-b^4+2\,a^  2\,b^2-a^4}}{2\,a} \right]  , \left[ 0 , 0 \right] \right)\right)
\]
\end{eulerformula}
\begin{eulerprompt}
...
>insimg(30);
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-075.png}
\begin{eulercomment}
Tentu saja,
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT_Shekar Juniarifah_Geo-083-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-088.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT_Shekar Juniarifah_Geo-091-large.png}
\eulerimg{0}{images/EMT_Shekar Juniarifah_Geo-092-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT_Shekar Juniarifah_Geo-099-large.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{1}{images/EMT_Shekar Juniarifah_Geo-108-large.png}
...
\]
\end{eulerformula}
\eulerimg{0}{images/EMT_Shekar Juniarifah_Geo-116-large.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-118.png}
\begin{eulercomment}
...
\]
\end{eulerformula}
\eulerimg{2}{images/EMT_Shekar Juniarifah_Geo-120-large.png}
\eulerimg{1}{images/EMT_Shekar Juniarifah_Geo-121-large.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-123.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-128.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-132.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-133.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-134.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-135.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-136.png}
\begin{eulercomment}
\end{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-137.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-138.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-139.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-140.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-141.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-142.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-143.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],add=1,color=12,points=1);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-144.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-145.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-149.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-150.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-151.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-152.png}
\begin{eulerprompt}
>A=[-2,-2]; plotPoint(A,"A"):
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-153.png}
\begin{eulerprompt}
>B=[2,-2]; plotPoint(B,"B"):
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-154.png}
\begin{eulerprompt}
>C=[0,3]; plotPoint(C,"C"):
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-155.png}
\begin{eulerprompt}
>plotSegment (A,B,"a"):
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-156.png}
\begin{eulerprompt}
>plotSegment(B,C,"b"):
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-157.png}
\begin{eulerprompt}
>plotSegment(A,C,"c"):
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-158.png}
\begin{eulerprompt}
...
>plotPoint(O,"O"):
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-159.png}
\begin{eulerprompt}
...
>plotCircle(c,"Lingkaran luar segitiga ABC"):
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-160.png}
\begin{eulercomment}
2. Gambarlah suatu parabola yang melalui 3 titik yang diketahui.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-161.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-162.png}
\begin{eulercomment}
3. Gambarlah suatu segi-4 yang diketahui keempat titik sudutnya,
misalnya A, B, C, D.
\end{eulercomment}
...
>setPlotRange(-3.5,3.5,-3.5,3.5):
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-163.png}
\begin{eulerprompt}
>A=[-2,-2]; plotPoint(A,"A"):
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-164.png}
\begin{eulerprompt}
>B=[2,-2]; plotPoint(B,"B"):
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-165.png}
\begin{eulerprompt}
>C=[2,2]; plotPoint(C,"C"):
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-166.png}
\begin{eulerprompt}
>D=[-2,2]; plotPoint(D,"D"):
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-167.png}
\begin{eulerprompt}
>plotSegment(A,B,"");
>plotSegment(B,C,"");
>plotSegment(C,D,"");
...
>aspect(1):
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-168.png}
\begin{eulerprompt}
...
>plotPoint(P,"P"):
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-169.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-170.png}
\begin{eulercomment}
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-173.png}
\begin{eulercomment}
...
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-174.png}
\begin{eulercomment}
Batasan ke garis PQ
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-175.png}
\begin{eulercomment}
Grafik yang lebih menarik
\end{eulercomment}
\begin{eulerprompt}
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-176.png}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\eulerimg{27}{images/EMT_Shekar Juniarifah_Geo-177.png}
\end{eulernotebook}
\end{document}
